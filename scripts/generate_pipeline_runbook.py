...
def collect_artifacts(root: Path) -> dict[str, list[Path]]:
    return {
        ...
        "completionAudits": find_all(root, ["**/pipeline-completion-audit.md", "**/pipeline-completion-audit.json"]),
...
def build_runbook(root: Path, project: str, target: str) -> dict[str, Any]:
    ...
    groups = [
        ...
        ("phase3Demos", "Phase 3", "Standalone implementation demo", "demo"),
        ("phase3Screenshots", "Phase 3", "Implementation screenshot", "visual"),
        ("phase3DesignQaReports", "Phase 3", "Design QA gate", "qa"),
        ("completionAudits", "Audit", "Pipeline completion audit", "audit"),
